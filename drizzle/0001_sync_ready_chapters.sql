...
ALTER TABLE "chapter" ADD COLUMN "sortKey" text;--> statement-breakpoint
ALTER TABLE "chapter" ADD COLUMN "deletedAt" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "project" ADD COLUMN "deletedAt" timestamp with time zone;--> statement-breakpoint
